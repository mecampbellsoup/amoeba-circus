  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved amoeba as @amoeba" do
        ...
        post :create, {:amoeba => { "name" => "invalid value" }}, valid_session
        assigns(:amoeba).should be_a_new(Amoeba)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested amoeba" do
        ...
        Amoeba.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => amoeba.to_param, :amoeba => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the amoeba as @amoeba" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Amoeba.any_instance.stub(:save).and_return(false)
        put :update, {:id => amoeba.to_param, :amoeba => { "name" => "invalid value" }}, valid_session
        assigns(:amoeba).should eq(amoeba)
      end
